        ...
        <!-- Info Alert Modal -->
        <div id="delete-alert-modal_{{ $group->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <form action="{{ route('permissions-group.destroy',$group->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <input  type="hidden" name="permissions_group_id" value="{{ $group->id }}">
