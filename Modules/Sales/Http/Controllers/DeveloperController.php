...
class DeveloperController extends Controller
{
    ...
    public function index($agency)
    {
        ...
        $developers = Developer::where('agency_id', $agency)->where('business_id', auth()->user()->business_id)->paginate($per_page);


        return view('sales::settings.developers.index', compact('agency', 'developers', 'business'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return back()->with(flash(trans('sales.developer_created'), 'success'));
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function update($id, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return back()->with(flash(trans('sales.developer_updated'), 'success'));
        } catch (\Exception $e) {
    ...
    public function destroy()
    {
        ...
        Developer::findorfail(request('developer_id'))->delete();

        return back()->withInput()->with(flash(trans('sales.developer_deleted'), 'success'));
    }
}