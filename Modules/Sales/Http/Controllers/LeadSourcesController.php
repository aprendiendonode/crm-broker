...
class LeadSourcesController extends Controller
{
    ...
    public function index($agency)
    {
        ...
        $lead_sources = LeadSource::where('agency_id', $agency)->where('business_id', auth()->user()->business_id)->paginate($per_page);


        return view('sales::settings.leadsource.index', compact('agency', 'lead_sources', 'business'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return back()->with(flash(trans('sales.source_created'), 'success'));
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function update($id, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return back()->with(flash(trans('sales.source_updated'), 'success'));
        } catch (\Exception $e) {
    ...
    public function destroy()
    {
        ...
        LeadSource::findorfail(request('source_id'))->delete();

        return back()->withInput()->with(flash(trans('sales.source_deleted'), 'success'));
    }
}