...
<div class="col-md-4">
    ...
    @forelse($task->staff as $user)
            ...
            <div class="checkbox checkbox-primary mb-2">
                <input  checked  id="task_{{ $client->id}}_{{ $task->id }}_{{ $user->id }}" value="" disabled type="checkbox">
                <label class="font-weight-medium text-muted" for="task_{{ $client->id}}_{{ $task->id }}_{{ $user->id }}">
