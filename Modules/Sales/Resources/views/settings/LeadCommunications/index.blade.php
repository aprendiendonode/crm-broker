...
@section('title',trans('sales.communications'))
@section('css')
...
<div class="content p-3">
            ...
            <div class="d-flex justify-content-between mb-3">
               <h4>
                   @lang('sales.manage_lead_communication')
               </h4>

              
                <button onclick="show_add_div()" type="button" class="btn btn-info waves-effect waves-light">
                    <span class="btn-label"><i class="fe-plus-square"></i></span>@lang('sales.add_communication')
                </button>
            ...
            <div>
                <table  class="table table-bordered toggle-circle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $communication->{'name_'.app()->getLocale()} }}</td>
                            <td>{{ $communication->created_at->toFormattedDateString() }}</td>
...
function  show_add_div(){
 var  div = document.querySelector('.add_communication');
 ...
 var  div = document.querySelector('.edit_communication_'+id);
    if(div.style.display === 'none'){
