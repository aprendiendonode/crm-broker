...
@section('title',trans('sales.opportunity_stage'))
@section('css')
...
<div class="content p-3">
            ...
            <div class="d-flex justify-content-between mb-3">
               <h4>
                   @lang('sales.manage_opportunity_stage')
               </h4>

              
                <button onclick="show_add_div()" type="button" class="btn btn-info waves-effect waves-light">
                    <span class="btn-label"><i class="fe-plus-square"></i></span>@lang('sales.add_stage')
                </button>
            ...
            <div class="mb-2 add_type " @if(!session()->has('open-tab')) style="display: none;opacity:0;transition:0.7s" @endif>
                @include('sales::settings.opportunitystage.create')
            </div>
                ...
                <table  class="table table-bordered toggle-circle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $stage->created_at->toFormattedDateString() }}</td>
                   
           
                            <td>
                                @include('sales::settings.opportunitystage.controlls')
                               
                            </td>

                        
                            @include('sales::settings.opportunitystage.modals')
  
                        </tr>
                    

                            <tr  class="edit_team_{{ $stage->id }}"  @if( (session()->has('open-edit-tab') && session('open-edit-tab') ==  $stage->id ))  @else style="display: none;opacity:0;transition:0.7s" @endif >
                                <td colspan="8">

                                    @include('sales::settings.opportunitystage.edit')
