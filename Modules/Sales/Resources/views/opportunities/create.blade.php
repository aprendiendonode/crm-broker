<form  action="{{ url('sales/manage_opportunities') }}" data-parsley-validate="" method="POST" enctype="multipart/form-data">
<div class="row">
        @csrf
    ...
    <div class="col-md-4">
        ...
        <div class="form-group d-flex justify-content-between">
            ...
            @can('manage_opportunity_setting')
                ...
                style="margin-top:4px;"
                   data-plugin="tippy" title="@lang('sales.new_opportunity_source')"
            ...
            @endcan   
              <div style="flex:4">
                    ...
                    <select  style="" class="form-control select_souce_id select2" name="source_id" data-toggle="select2" data-placeholder="@lang('sales.opportunity_sources')" required>
                        <option value="" class="font-weight-medium text-muted"></option>
                    @forelse($opportunity_sources as $source)
        ...
        <div class="form-group d-flex justify-content-between">
            ...
            data-plugin="tippy" title="@lang('sales.new_opportunity_type')"
            data-tippy-placement="top-start" 
           ...
           @endcan     
            ...
            <select  class="form-control select2 select_type_id" name="type_id"
                    data-toggle="select2" data-placeholder="@lang('sales.opportunity_types')" required>
                    <option value=""></option>

                    @forelse($opportunity_types as $type)
        ...
        <div class="form-group d-flex justify-content-between">
            @can('manage_opportunity_setting')
            <a style="margin-top:4px;"
            data-plugin="tippy" title="@lang('sales.new_opportunity_qualification')"
            data-tippy-placement="top-start" 
            ...
            <select  class="form-control select2 select_qualification_id" name="qualification_id" data-toggle="select2" data-placeholder="@lang('sales.opportunity_qualifications')" required >
        
                    <option value=""></option>
                    @forelse($opportunity_qualifications as $ql)
        ...
        <div class="form-group d-flex justify-content-between" >
            ...
            data-plugin="tippy" title="@lang('sales.new_opportunity_communication')"
            data-tippy-placement="top-start" 
            ...
            <select  class="form-control  select_communication_id select2 " name="communication_id"
                ...
                <option name="" ></option>
                     @forelse($opportunity_communications as $communication)
        ...
        <div class="form-group d-flex justify-content-between">
            ...
            <a style="margin-top:4px;"
                    data-plugin="tippy"
                    title="@lang('sales.new_opportunity_priority')"
                    data-tippy-placement="top-start" 
            ...
            <div style="flex:4">
                ...
                <select  class="form-control select2 select_priority_id" name="priority_id" data-placeholder="@lang('sales.priority')"
                    ...
                    @forelse($opportunity_priorities as $priority)
...
<div class="col-md-4">
    ...
    <div class="form-group">
            ...
            {{-- <input type="text" class="form-control" value="ZAHRA SABEEL MOHAMED ALBLOUSHI" name="opportunity_name" required="" data-parsley-id="13"> --}}
        ...
        @endcan   
           <div style="flex:4">
                ...
                <select  class="form-control select_property_id select2 " name="property_id"
                        ...
                        @forelse($opportunity_properties as $property)
