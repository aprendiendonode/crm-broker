...
@can('add_question_on_opportunity')    
    ...
    <button onclick="event.preventDefault();show_question_form({{ $opportunity->id }});" class="btn mb-3  btn-primary waves-effect waves-light mr-2">
        <span class="btn-label"><i class="mdi mdi-plus"></i></span> @lang('sales.question')
    </button>


    <form action="{{ url('sales/manage_opportunities/question/'.$opportunity->id) }}" data-parsley-validate="" method="POST">
        @csrf
        @method('PATCH')
        <div class="row d-none  question_form_{{ $opportunity->id }}" >
                <div class="col-md-12 mb-2">

                        <textarea required class="form-control" name="question_body_{{ $opportunity->id }}"  cols="30" rows="6">{{ old('question_body_'.$opportunity->id) }}</textarea>
            ...
            <div class="table-responsive">
                ...
                <table class=" table table-bordered toggle-circle mb-0"  >
                    ...
                    <tbody>
                        ...
                        @forelse($opportunity->questions as $question)
                        <tr>
