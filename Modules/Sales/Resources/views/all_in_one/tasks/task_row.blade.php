...
<div class="col-md-4">
    ...
    <div>
        ...
        <p>{{ $task->staff ? $task->staff->count() : '' }}</p>
    ...
    {{-- <img src="" alt="image" class="img-fluid avatar-sm rounded mt-2"> --}}
            ...
            <div class="checkbox checkbox-primary mb-2">
                <input  checked  id="task_{{ $opportunity->id}}_{{ $task->id }}_{{ $user->id }}" value="" disabled type="checkbox">
                <label class="font-weight-medium text-muted" for="task_{{ $opportunity->id}}_{{ $task->id }}_{{ $user->id }}">
