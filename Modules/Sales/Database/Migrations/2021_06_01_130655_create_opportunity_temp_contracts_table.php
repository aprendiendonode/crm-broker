...
class CreateOpportunityTempContractsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('opportunity_temp_contracts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('opportunity_temp_contracts');
    }
}
