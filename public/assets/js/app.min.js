...
function(n){"use strict";function
 ...
 t.prototype._saveConfig=function(t){this.config=n.extend(this.config,t)},
 t.prototype.updateConfig=function(t,e){var i={};if("object"==typeof e&&null!==e)
 {var a=this.config[t];i[t]=n.extend(a,e)}else i[t]=e;this._saveConfig(i)},
 t.prototype.loadConfig=function(){var t=JSON.parse(this.body.attr("data-layout")?this.body.attr("data-layout"):"{}"),e=n.extend({},
    {
    mode:'dark',
    width:"fluid",
    menuPosition:"fixed"
    ,sidebar:{color:"dark",size:"condensed",showuser:!1},topbar:{color:"dark"},showRightSidebarOnPageLoad:!1});return t&&(e=n.extend({},e,t)),e},t.prototype.applyConfig=function(){this.config=this.loadConfig(),this.leftSidebar.init(),this.topbar.init(),
    ((this.leftSidebar.parent=this).topbar.parent=this)
    // changeMode(this.config.mode)
   
    ,
    this.changeLayoutWidth(this.config.width),
    this.changeMenuPositions(this.config.menuPosition);
    var t=n.extend({},this.config.sidebar);this.leftSidebar.changeColor(t.color),this.leftSidebar.changeSize(t.size),this.leftSidebar.showUser(t.showuser);var e=n.extend({},this.config.topbar);
